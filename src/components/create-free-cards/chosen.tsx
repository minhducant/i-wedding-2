      ...
      <Box
        ...
        <Box className="col-span-2 md:col-span-1  p-4 text-center flex flex-col gap-4">
          <Box
            ...
            <Box className="text-left">
              ...
              <Text fontSize="14px" lineHeight="1.6"   fontFamily={'"Quicksand", sans-serif'} color={"rgb(0, 0, 0)"}>
          ...
          <Box
            ...
            <Box className="text-left">
              ...
              <Text fontSize={"sm"}   fontFamily={'"Quicksand", sans-serif'} color={"rgb(0, 0, 0)"}>
          ...
          <Box
            ...
            <Image src="/heart.png" className="w-[85px] h-[85px]" />
            <Box className="text-left">
              <Text fontWeight={"bold"}   fontFamily={'"Quicksand", sans-serif'}>Rất nhiều tính năng được sử dụng</Text>
              <Text fontSize={"sm"}   fontFamily={'"Quicksand", sans-serif'} color={"rgb(0, 0, 0)"}>
        ...
        <Box className="col-span-2 md:col-span-1  p-4 text-center flex flex-col gap-4">
          ...
          <Box
            ...
            <Image src="/heart.png" className="w-[85px] h-[85px]" />
            <Box className="text-left">
              <Text fontWeight={"bold"}   fontFamily={'"Quicksand", sans-serif'}>Tiết kiệm chi phí và thời gian</Text>
              <Text fontSize={"sm"}   fontFamily={'"Quicksand", sans-serif'} color={"rgb(0, 0, 0)"}>
          ...
          <Collapsible.Root
            ...
            <Collapsible.Content>
              <Box
                ...
                className="p-8">
                <Text className="text-justify"   fontFamily={'"Quicksand", sans-serif'}>
