      ...
      <Box
        ...
        <Box className="col-span-3 md:col-span-1">
          <Box
            ...
            <Box position={"relative"}>
             ...
             <Box
              ...
              >
                ...
                <Text fontSize="xs"    fontFamily={'"Quicksand", sans-serif'} alignContent={'center'}>Giao diện MIỄN PHÍ</Text>
              </Box>
            </Box>
            ...
            <Box p="4">
              ...
              <Text fontSize="sm" color="gray.600" mb="4"   fontFamily={'"Quicksand", sans-serif'}>
          ...
          <Box
            ...
            <Box position={"relative"}>
              ...
              >
                ...
                <Text fontSize="xs" alignContent={'center'}   fontFamily={'"Quicksand", sans-serif'}>Giao diện MIỄN PHÍ</Text>
              </Box>
            </Box>
        ...
        <Box className="col-span-3 md:col-span-1">
          <Box
            ...
            <Box p="4">
              <Text fontWeight="bold" fontSize="lg" mb="1"   fontFamily={'"Quicksand", sans-serif'}>
                Romantic
              </Text>
              <Text fontSize="sm" color="gray.600" mb="4"   fontFamily={'"Quicksand", sans-serif'}>
